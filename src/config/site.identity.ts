export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'youpinews',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Youpinews',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'youpinews.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://youpinews.com',
